...
1. Analyze all loaded context (idea file, brief, AC) to identify business rules, including. If information needed is missing from all of these, ask the user a focused question rather than inventing it:
