...
3. On confirmation:
   ...
   - Overwrite `project/project_config.md` with exactly this content:
     ...
     ```
4. Confirm: "✓ Cleared project/context/ and project/reference/, reset project_config.md to its unconfigured state, deleted project/status.md, and cleared workspace/. Run /config to configure this project."
